...
import { movieCatalog } from "../mocks/movieCatalog";
...
const MovieCatalogPage: FC = () => {
  ...
  useEffect(() => {
    const fetchMovies = async () => {
      try {
        if (IS_DEV_MODE) {
          setMovies((prevMovies) => [...prevMovies, ...movieCatalog.items]); // in case API limit using mocks instead
        } else {
